...
#----添加遥感
def build_xView2DOTA(image_set, args):
    PATHS = {
        "train": ("/data/jianhonghan/遥感域适应数据集/xView/crop_800_100_3c/train_images",
                  "/data/jianhonghan/遥感域适应数据集/xView/crop_800_100_3c/coco_annotations/train_3c.json"),
        "train_reg": ("/data/jianhonghan/遥感域适应数据集/xView/crop_800_100_3c/train_images",
                      "/data/jianhonghan/遥感域适应数据集/xView/crop_800_100_3c/coco_annotations/train_3c.json"),
        ...
        "eval_debug": ("/data/jianhonghan/遥感域适应数据集/DOTA1.0/crop_800_100_3c/val/train_images",
                       "/data/jianhonghan/遥感域适应数据集/DOTA1.0/crop_800_100_3c/annotations/val_3c.json"),
        "test": ("/data/jianhonghan/遥感域适应数据集/DOTA1.0/crop_800_100_3c/val/train_images",
                 "/data/jianhonghan/遥感域适应数据集/DOTA1.0/crop_800_100_3c/annotations/val_3c.json" ),
    }
...
def build_city(image_set, args):
    PATHS = {
        ...
        "train_reg": ("/data/jianhonghan/自然场景域适应数据集/cityscapes_all/cityscapes_all/cityscapes/leftImg8bit/train",
                      "/data/jianhonghan/自然场景域适应数据集/cityscapes_all/cityscapes_all/CocoFormatAnnos/cityscapes_train_cocostyle.json"),
        "val": ("/data/jianhonghan/自然场景域适应数据集/cityscapes_all/cityscapes_all/foggy_cityscapes/leftImg8bit_foggy/val",
                "/data/jianhonghan/自然场景域适应数据集/cityscapes_all/cityscapes_all/CocoFormatAnnos/cityscapes_foggy_val_cocostyle.json"),
        "eval_debug": ("/data/jianhonghan/自然场景域适应数据集/cityscapes_all/cityscapes_all/foggy_cityscapes/leftImg8bit_foggy/val",
                       "/data/jianhonghan/自然场景域适应数据集/cityscapes_all/cityscapes_all/CocoFormatAnnos/cityscapes_foggy_val_cocostyle.json"),
        "test": ("/data/jianhonghan/自然场景域适应数据集/cityscapes_all/cityscapes_all/foggy_cityscapes/leftImg8bit_foggy/val",
                 "/data/jianhonghan/自然场景域适应数据集/cityscapes_all/cityscapes_all/CocoFormatAnnos/cityscapes_foggy_val_cocostyle.json" ),
    }
